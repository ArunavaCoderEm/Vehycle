      ...
      <div className='max-w-[25em] rounded-sm bg-gradient-to-b from-gray-600 to-gray-900 items-center justify-center align-middle mt-10 mx-auto p-2 shaa my-3'>
        ...
        <form className='m-2 px-3' onSubmit={onSubmitHandle}>
          ...
          <div className="relative w-full flex justify-center">
              ...
              <button
                type="button"
                className="w-full placeholder:text-pink-500 text-pink-500 border-2 border-solid border-gray-600 focus:border-gray-600 focus:ring-0 focus:outline-none h-10 text-center rounded-md bg-white"
                onClick={handleClick}
                >
                {avattext}
                </button>
