    ...
    <>
        ...
        <>
           ...
           <div className="grid grid-cols-2 md:grid-cols-3 p-3 lg:grid-cols-6 gap-4">
                <Link to="/catepage/engine" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
                ...
                <Link to="/catepage/diagonistic" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
                ...
                <Link to="/catepage/performance" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
                ...
                <Link to="/catepage/body" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
                ...
                <Link to="/catepage/paint" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
                ...
                <Link to="/catepage/detailing" className='bg-gradient-to-b transition-all sha h-56 duration-300 shadow hover:scale-95 p-4 from-pink-600/70 to-black rounded-lg'>
