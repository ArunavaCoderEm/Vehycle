  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 p-3 sm:grid-cols-1'>
        ...
        <div className='p-2 flex flex-col justify-center items-center'>
          ...
          <h3 className='mt-4 bg-gradient-to-b from-black/30 font-semibold shap py-2 px-3 rounded-full'>💁🏻‍♂️ Helper at your door 💁🏻‍♂️</h3>
          <ul className='w-3/4 my-2 p-3 rounded-lg'>
            ...
            <li className='list-disc my-1 text-[18px]'>
              <span className='font-bold text-pink-600 mr-2'>Transparent Relation :</span>
