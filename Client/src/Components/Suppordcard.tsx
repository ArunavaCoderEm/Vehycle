...
export default function Suppordcard(props:any):React.ReactNode {
  return (
    <div className='bg-white my-3 flex border-[2px] border-pink-600 justify-between items-center p-2 rounded-lg h-auto'>
        ...
        <h1 className='font-bold'><span className='text-pink-600'>Customer : </span> {props.name} <span className='text-xs'>{props.def}</span></h1>
        ...
        <h1 className='font-bold'><span className='text-pink-600'>Cont : </span> {props.con}</h1>
